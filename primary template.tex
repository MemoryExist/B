...
\begin{thebibliography}{9}%宽度9，表示标签（Label）的最大宽度预留
    \bibitem[1]{jinjieru2022}
    金洁茹.
    \newblock 应急医疗物资通用航空调度模型优化研究[D].
    \newblock 南京: 南京航空航天大学, 2022.
    \bibitem[2]{songliang2018}
    宋亮.
    \newblock 面向物流行业的车辆路径问题数学建模与近似算法设计[D].
    \newblock 哈尔滨: 哈尔滨工业大学, 2018.
\end{thebibliography}
...
\begin{center}\textbf{问题一}\end{center}
...
\begin{center}\textbf{问题二}\end{center}
